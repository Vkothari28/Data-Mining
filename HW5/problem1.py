...
def backward(x, y, z):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    dldz=compute_dL_dz(z,y)
    dL_db=compute_dL_db(dldz,1)
    dz_dw=compute_dz_dw(x)
    dL_dw=compute_dL_dw(dldz,dz_dw)
    #########################################
    return dL_dw, dL_db
    #-----------------
    '''  
