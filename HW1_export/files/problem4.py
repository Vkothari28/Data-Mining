...
def rank_players_BA(X7):
    ...
    R1=X7.sort_values(['BA'], inplace=False, ascending=False)
...
def rank_players_OBP(X8):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X8 = X8.sort_values(['OBP'], inplace=False, ascending=False)
    #########################################
    return X8
    #-----------------
    '''  
...
def rank_players_SLG(X11):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X11 = X11.sort_values(['SLG'], inplace=False, ascending=False)
    #########################################
    return X11
    #-----------------
    '''  
